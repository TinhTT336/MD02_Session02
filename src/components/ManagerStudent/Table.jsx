...
import ModalEditStudents from "./ModalEditStudents";
import ModalDeleteStudents from "./ModalDeleteStudents";
...
export default class Table extends Component {
  ...
  handleCloseDelete = (status) => {
    this.setState({ showDelete: status });
  };
  render() {
    return (
      <>
        {this.state.showEdit === true ? (
          <ModalEditStudents handleCloseEdit={this.handleCloseEdit} />
        ) : (
          <></>
        )}
        {this.state.showDelete === true ? (
          <ModalDeleteStudents handleCloseDelete={this.handleCloseDelete} />
        ) : (
          <></>
        )}
        <div className="m-5">
